...
const AboutPage = ({ teamMembers }) => {
  const sections = [
    ...
    },
    {
      ...
      content:
        "Dhruv Rugs International is equally passionate about discharging its social obligations as it is about retaining its position in the world market as a leading manufacturer and exporter of woolen, silk, viscose and cotton carpets from India. The company is committed to contributing to various social causes.",
    },
  ];
        ...
        <div className="mb-20">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg text-gray-700 mb-6">
              ...
              Canada, Europe Japan & Australia. Dhruv Rugs International range of
